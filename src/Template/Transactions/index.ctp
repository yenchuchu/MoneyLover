    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th><?= $this->Paginator->sort('transaction_money') ?></th>
                <th><?= $this->Paginator->sort('day_transaction') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $this->Number->format($transaction->transaction_money) ?></td>
                <td><?= h($transaction->day_transaction) ?></td>
