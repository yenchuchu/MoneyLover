...
//                        }?>
                ...
                <div class="modal-footer" style="margin-top: 29px;">
                    <button type="button" class="btn btn-default"
                            data-dismiss="modal" id="close-modal-ava">
                        Close
                    </button>
        ...
        <div class="modal-content">
            ...
            <form action="/MoneyLover/users/change_password/<?php echo $id; ?>" id="UserChangePasswordForm"
                ...
                <div class="modal-footer" id="footer-change-pass" style="position: relative; ">
                    ...
                    <button type="submit" class="btn btn-md btn-change-pass"   id="button">
                        Save changes
                    </button>
                </div>
            </form>
...
//        $srcOld = $('#src-ava-old').text().trim();
//        $("#close-modal-ava").click(function() {
//            $("#load-avatar-upload").attr("src", "/MoneyLover/image_avatar/" + $srcOld);
//        });
//    }
