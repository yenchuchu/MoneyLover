...
class WalletsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'info' => ['type' => 'string', 'length' => 500, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'money_current' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'money_current' => 1,
            'created' => '2016-03-14 03:24:04',
            'modified' => '2016-03-14 03:24:04'
        ],
    ];
}
